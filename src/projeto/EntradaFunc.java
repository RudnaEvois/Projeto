 ...
 * @author USER
 */
public class EntradaFunc extends javax.swing.JFrame {

    /**
     * Creates new form EntradaFunc
     */
    public EntradaFunc() {
        initComponents();
    }
 ...
 JOptionPane.showMessageDialog(null, "Código do Produto: "+p.getCod()+"\n Nome: "+p.getNome()+"\n Quantidade: "+p.getQuant()+"\n Preço de Custo "+p.getValorCusto()+"\n Valor de Venda: "+p.getValorVenda());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EntradaFunc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
